...
public class FileCopy {
    public static void main(String[] args) {
        //복사본<== (OutputStream 객체사용) [프로그램] <== (InputStream 객체 사용)원본
        String str = "";
        BufferedReader reader = null;
        BufferedWriter writer = null;

        String file1 = "C:\\Users\\PJY\\IdeaProjects\\hello-spring\\javaProject1213\\aa.txt";//원본파일
        String file2 = "C:\\Users\\PJY\\IdeaProjects\\hello-spring\\javaProject1213\\b.txt";//복사본
