...
public class MemberUse {
    public static void main(String[] args) {
        ...
        ObjectOutputStream oos = null; //매모리에 있는 객체를 파일로 저장시켜주는 객체
        ...
        try {
            //직렬화 : 메모리 -> 프로그램 -> 파일
            fos = new FileOutputStream("C:\\Users\\PJY\\IdeaProjects\\hello-spring\\javaProject1213\\Object.dat");
            oos = new ObjectOutputStream(fos);
            oos.writeObject(m1); //m1 객체를파일에 저장
            oos.writeObject(m2);
            oos.writeObject(m3);
        ...
        try {
            fis = new FileInputStream("C:\\Users\\PJY\\IdeaProjects\\hello-spring\\javaProject1213\\Object.dat");
