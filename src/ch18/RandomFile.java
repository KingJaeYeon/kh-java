...
public class RandomFile {
    public static void main(String[] args) {
        ...
        try { //r:읽기전용, w:쓰기전용, rw: 읽기, 쓰기
            RandomAccessFile file = new RandomAccessFile("C:\\Users\\PJY\\IdeaProjects\\hello-spring\\javaProject1213\\rand.txt","rw");
            ...
            while (file.getFilePointer() < file.length()){
                //파일의 내용보다 파일포인터의 위치값이적으면 반복
                str = file.readLine();
                //한글처리
                //String(문자열, 캐릭터셋) 인코딩 방식 변환
                //iso-8859_1, 8859_1 : 서유럽언어 인코딩 방식
